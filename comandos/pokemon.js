...
message.channel.send("Pegando informação da api...").then(msg => {
  get(options).then(body => {
    ...
    .setColor("#ff2050")
    .setFooter(`Pokemon - ${body.info.weakness}`, `https://courses.cs.washington.edu/courses/cse154/webservices/pokedex/${body.images.weaknessIcon}`)
